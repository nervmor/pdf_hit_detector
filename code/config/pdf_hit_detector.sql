...
--
-- Definition of table `pdf_pre_hash`
--

DROP TABLE IF EXISTS `pdf_pre_hash`;
CREATE TABLE `pdf_pre_hash` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `pre_size` int(10) unsigned NOT NULL,
  `hash_1` int(10) unsigned NOT NULL,
  `hash_2` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `pdf_pre_hash`
--

/*!40000 ALTER TABLE `pdf_pre_hash` DISABLE KEYS */;
/*!40000 ALTER TABLE `pdf_pre_hash` ENABLE KEYS */;


--
-- Definition of table `pdf_pre_hash_description`
--

DROP TABLE IF EXISTS `pdf_pre_hash_description`;
CREATE TABLE `pdf_pre_hash_description` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `pdf_pre_hash_id` int(10) unsigned NOT NULL,
  `pdf_description_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_pdf_pre_hash_description_1` (`pdf_pre_hash_id`),
  KEY `FK_pdf_pre_hash_description_2` (`pdf_description_id`),
  CONSTRAINT `FK_pdf_pre_hash_description_1` FOREIGN KEY (`pdf_pre_hash_id`) REFERENCES `pdf_pre_hash` (`id`),
  CONSTRAINT `FK_pdf_pre_hash_description_2` FOREIGN KEY (`pdf_description_id`) REFERENCES `pdf_description` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `pdf_pre_hash_description`
--

/*!40000 ALTER TABLE `pdf_pre_hash_description` DISABLE KEYS */;
/*!40000 ALTER TABLE `pdf_pre_hash_description` ENABLE KEYS */;
